...
License:	LGPL v2+
Group:		Libraries
Source0:	http://ftp.gnome.org/pub/GNOME/sources/libsoup/2.37/%{name}-%{version}.tar.xz
...
BuildRequires:	glib2-devel >= 1:2.31.7
